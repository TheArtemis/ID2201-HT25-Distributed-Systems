...
EVAL="logical_test:run($SLEEP, $JITTER, $NODES)."
CMD="cd '$CURRENT_DIR' && erl -pa '$BEAM_DIR' -setcookie 1234 -sname logical_loggy -eval '$EVAL'"

echo ""
echo -e "${PURPLE}${BOLD}=== 🚀 Starting Erlang node LOGGY ===${NC}"
echo ""
...
echo -e "${WHITE}LOGGY: ${YELLOW}$CMD${NC}"
